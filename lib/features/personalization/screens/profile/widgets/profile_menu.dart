...
class RProfileMenu extends StatelessWidget {
  const RProfileMenu({super.key, this.icon = Iconsax.arrow_right_34, required this.onPressed, required this.title, required this.value});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onPressed,
      child: Padding(
        padding: EdgeInsets.symmetric(vertical: RSizes.spaceBtwItems / 1.5),
        child: Row(
          children: [
            Expanded(
              flex: 3,
