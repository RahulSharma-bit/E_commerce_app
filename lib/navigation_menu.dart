    ...
    return Scaffold(
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          indicatorColor: dark ? RColors.white.withValues(alpha: 0.1) : RColors.white.withValues(alpha: 0.1),
...
class NavigationController extends GetxController {
  ...
  final screens = [const HomePage(), Container(color: Colors.blue), Container(color: Colors.deepPurple), Container(color: Colors.orange)];
}
